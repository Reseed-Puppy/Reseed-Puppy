...
<head>
    ...
    <link rel="stylesheet" href="static/plugs/layui/css/layui.css?v=<?php echo time() ?>" media="all">
...
<script src="static/plugs/layui/layui.js?v=<?php echo time() ?>" charset="utf-8"></script>
<script>
